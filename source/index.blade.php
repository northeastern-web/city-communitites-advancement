            ...
            @foreach ($events->take(2) as $event)
                <div class="max-w-2xl w-full flex flex-col p-4 sm:w-1/2">
                    <a
                        ...
                        class="group block w-full h-full bg-gray-200 shadow-sm transition-colors duration-200 lg:flex hover:bg-gray-100 focus:outline-none focus:shadow-outline"
                    >
            ...
            @foreach (range(1, 3) as $item)
                <div class="max-w-md w-full flex flex-col p-4 sm:w-1/2 lg:w-1/3">
                    <a
                        ...
                        class="group block w-full h-full bg-gray-200 shadow-sm transition-colors duration-200 hover:bg-gray-100 focus:outline-none focus:shadow-outline"
                    >
