...
<<<<<<< HEAD
                    <a class="p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-500" href="https://www.facebook.com/NUengaged" target="_blank" aria-label="Facebook" title="Facebook">
=======
                    <a class="p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://www.facebook.com/NUengaged"  target="_blank" rel="noopener" aria-label="Facebook" title="Facebook">
>>>>>>> master
...
<<<<<<< HEAD
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-500" href="https://twitter.com/NUengaged" target="_blank" aria-label="Twitter" title="Twitter">
=======
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://twitter.com/NUengaged"  target="_blank" rel="noopener" aria-label="Twitter" title="Twitter">
>>>>>>> master
                        <svg aria-hidden="true" focusable="false" class="w-6 h-6" viewBox="0 0 24 24">
...
<<<<<<< HEAD
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-500" href="https://www.instagram.com/nuengaged/" target="_blank" aria-label="Instagram" title="Instagram">
=======
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://www.instagram.com/nuengaged/"  target="_blank" rel="noopener" aria-label="Instagram" title="Instagram">
>>>>>>> master
                        <svg aria-hidden="true" focusable="false" class="w-6 h-6" viewBox="0 0 24 24">
