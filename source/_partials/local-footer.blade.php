        ...
        <div class="-mx-2 flex flex-wrap justify-between">
            <div class="w-full px-2 lg:w-auto">
                ...
                <div class="mt-8 -mx-1 flex items-center">
                    <a class="p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://www.facebook.com/NUengaged" target="_blank" aria-label="Facebook" title="Facebook">
                    ...
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://twitter.com/NUengaged" target="_blank" aria-label="Twitter" title="Twitter">
                        <svg class="w-6 h-6" viewBox="0 0 24 24">
                    ...
                    <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:shadow-outline" href="https://www.instagram.com/nuengaged/" target="_blank" aria-label="Instagram" title="Instagram">
                        <svg class="w-6 h-6" viewBox="0 0 24 24">
