...
@section('body')
    ...
    >
        <div class="max-w-screen-2xl mx-auto px-4 lg:px-16">
    ...
    <section class="max-w-screen-2xl mx-auto px-4 py-16 lg:px-16">
    ...
    <section class="max-w-screen-2xl mx-auto px-4 pb-16 lg:px-16">
