...
@section('content')
        ...
        <x-kernl-accordion.base label="Spring trips">
            ...
            <x-kernl-accordion.item title="Domestic trips">
                <div class="prose max-w-3xl">
                    ...
                    <p><b><a href="https://lgbtcleveland.org/">Cleveland LGBT Community Center</a></b> (Cleveland, Ohio)—Volunteers will work with this organization, which enriches the Cleveland LGBTQ+ community through advocacy, support, education, and celebration. Activities may include working with youth groups, preparing safe-sex kits, canvassing in local neighborhoods, and preparing educational resources. Volunteers will also learn about the history of LGBTQ+ activism and advocacy in Cleveland.</p>
    ...
    <div class="mt-12 prose max-w-3xl lg:prose-lg">
        ...
        <p>In the event of a medical, security, political, or other emergency, ASB participants will immediately notify Northeastern’s Office of City and Community Engagement. Northeastern employs Aon WorldAware as a travel assistance and response provider, and Aon and Northeastern will work to facilitate the appropriate response. In an emergency scenario, every reasonable accommodation will be made to ensure the safety of ASB participants and get them back to Boston quickly. Unfortunately, we cannot offer a refund of trip fees. Learn more about <a href="https://www.aon.com/risk-services/worldaware/default.jsp">Aon WorldAware</a>.</p>
        <p>Read ASB’s <a href="https://www.northeastern.edu/communityservice/wp-content/uploads/2016/05/3.3.1.1-ASB-Handbook-1.docx">Program Handbook</a> for more information.</p>
