...
@section('content')
    <div class="prose max-w-3xl lg:prose-lg">
        ...
        <p>To learn more about the Alternative Spring Break program and this year’s trips, please review our detailed guide.</p>
    ...
    <div class="mt-12">
        <x-accordion label="Spring trips">
            ...
            <x-accordion-item title="Regional trips">
                <div class="prose max-w-3xl">
                    <p>Program fee: $400</p>
                    <p><b>Project Cure</b> (West Grove, Pennsylvania)—Volunteers will partner with Project Cure, the largest provider of donated medical supplies and equipment to developing countries around the world. They’ll work in a major distribution center in Pennsylvania to help pack and organize supplies for shipments. They’ll also connect with local and regional organizations that focus on public health.</p>
                </div>
            </x-accordion-item>
            <x-accordion-item title="Domestic trips">
                <div class="prose max-w-3xl">
                    <p>Program fee: $775</p>
                    <p><b>American Hiking Society</b> (location TBD)—Volunteers will participate in day hiking, trail work, and learn about the plant life and natural history of a region.</p>
                    <p><b>Best Friends Animal Society</b> (Kanab, Utah)—Volunteers will serve at the largest no-kill animal sanctuary in the country, which provides homes and care to a variety of animals, including cats, dogs, pigs, horses, bunnies, and birds. They will also have the opportunity to learn about animal advocacy issues surrounding breed discriminaton and state legislation. Projects may include cleaning, improving facilities, and socializing animals.</p>
                    <p><b>Cleveland LGBT Community Center</b> (Cleveland, Ohio)—Volunteers will work with this organization, which enriches the Cleveland LGBTQ+ community through advocacy, support, education, and celebration. Activities may include working with youth groups, preparing safe-sex kits, canvassing in local neighborhoods, and preparing educational resources. Volunteers will also learn about the history of LGBTQ+ activism and advocacy in Cleveland.</p>
                    <p><b>Homelessness and Housing Insecurity</b>(Seattle, Washington)—Volunteers will work with organizations such as FareStart and Northwest Harvest that provide support to people affected by homelessness and housing insecurity in Seattle. Volunteers will also learn about the history of housing insecurity in the region and local efforts to address the issue.</p>
                    <p><b>Peaceable Kingdom Retreat for Children</b> (Killeen, Texas)—Volunteers will work with this organization, which enables children with special needs and chronic illness to enjoy the health-giving benefits of nature. Activities may include assisting with classes and retreats, camp rehabilitation projects, farm animal care, cleaning, gardening, and administrative tasks.</p>
                    <p><b>Saguaro National Park</b> (Tucson, Arizona)—This park features a variety of animal and plant life, including majestic saguaro cacti. Volunteers will spend the week camping in the park and working directly with National Park Service crews to increase access to and maintenance of this natural resource through education and trail maintenance projects. </p>
                </div>
            </x-accordion-item>
            <x-accordion-item title="Global trips">
                <div class="prose max-w-3xl">
                    Program fee: $1,500</p>
                    <p><b>7 Elements</b> (Las Canas, Dominican Republic)—Volunteers will work with this organization to support its mission of improving health outcomes by creating a healthy physical and social environment. Volunteers will work on projects aimed at reducing waste and provide healthy and safe conditions for local communities.</p>
                    <p><b>Outreach 360</b> (Dominican Republic)—Volunteers will serve with Outreach 360, which provides opportunities for youth in Monte Cristi that seek to “Release the Hero Within”. Volunteers will work in the Neighborhood Learning Center to teach English classes and literacy skills and to complete other projects. Volunteers do not have to be fluent in Spanish to participate on this trip.</p>
                    <p><b>Plenitud Organic Farming and Sustainable Living Center</b> (Las Marias, Puerto Rico)—Volunteers will work with Plenitud to practice sustainable and harmonious living, learn about permaculture and sustainable agriculture, and contribute to the center’s operations. Tasks may involve food production, stormwater management, bio-construction, composting, and education.</p>
                </div>
            </x-accordion-item>
        </x-accordion>
    </div>
    <div class="mt-12 prose max-w-3xl lg:prose-lg">
        ...
        <p>For ASB trips outside Boston, volunteers will fly to their destinations via Logan International Airport. Volunteers for local and regional trips will drive to the host site. Teams travel together, leaving February 29 and returning March 7.</p>
        ...
        <p>Local trips: $250<br>
        Regional trips: $400<br>
        ...
        <p>Some ASB volunteers raise money toward their program fees. Here are some resources to help: Use these strategies from one of our ASB partners, the Best Friends Animal Society.</p>
        <ul>
