...
@section('content')
    <div class="prose max-w-3xl lg:prose-lg">
        ...
        <ul>
            <li>
                ...
                <p>HVT volunteers work one-on-one with poor and homeless adults to provide them food and clothing. </p>
            </li>
            <li>
                <h4 class="font-bold">Let’s Get Ready</h4>
                <p>HVT volunteers work with a small group of high school students to help prepare them for the SATs and college application process.</p>
            </li>
            <li>
                <h4 class="font-bold">American Red Cross Home Fire Campaign</h4>
                <p>HVT volunteers help provide fire-safety information and other materials to local residents. They also help to assess existing smoke alarms, install alarms, or replace alarm batteries.</p>
            </li>
            <li>
    ...
    <div class="mt-12">
        <x-accordion label="Roles and Positions">
            <x-accordion-item title="HVT Volunteers">
                <div class="prose max-w-3xl">
                    <p>HVT Volunteers commit to serving at a community-based organization once a week for one academic semester. They are expected to:</p>
                    <ul>
                        <li>Complete the HVT training module prior to beginning service</li>
            ...
            <x-accordion-item title="HVT Team Leaders">
                <div class="prose max-w-3xl">
                    <p>HVT Team Leaders serve as the critical link between City and Community Engagement, their HVT team, and their community partner organization. The Team Leader is responsible for guiding a team of 3–10 HVT volunteers, managing communication between the team and community partner, and supporting volunteers through service and engagement during the semester. Team Leaders also must:</p>
                    <ul>
                        <li>Attend Team Leader Orientation</li>
                        <li>Guide their HVT team to and from service each week</li>
