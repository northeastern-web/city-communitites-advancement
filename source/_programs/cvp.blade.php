...
@section('content')
    ...
    <div class="mt-12">
        <x-kernl-accordion.base label="Roles and Positions">
            <x-kernl-accordion.item title="826 Boston">
                <div class="prose max-w-3xl">
                    <p><b>Available Times</b>:</p>
                    <ul>
                        <li>Monday 4:00 p.m. to 6:45 p.m.</li>
                        <li>Tuesday 4:00 p.m. to 6:45 p.m.</li>
                        <li>Wednesday 4:00 p.m. to 6:45 p.m.</li>
                        <li>Thursday 4:00 p.m. to 6:45 p.m.</li>
                    </ul>
                    <p><b>Description of Site</b>: 826 Boston is a nonprofit youth writing and publishing organization that empowers traditionally underserved students ages 6 to18 to find their voices, tell their stories, and gain communication skills to succeed in school and in life.  Their services are structured around the understanding that great leaps in learning can happen with one-on-one attention and that strong writing skills are fundamental to future success. With this understanding in mind, they provide after-school tutoring, field trips, creative writing workshops, in-school tutoring, help for English Language Learners, and in-depth publishing projects.</p>

                    <p><b>Population Served</b>: Youth, age 7 to 16</p>

                    <p><b>Location</b>: Virtual</p>

                    <p><b>Primary Focus</b>: Education - after school enrichment, education - tutoring</p>

                    <p><b>Type of Placement</b>: Flexible Placement (up to 4 people)</p>

                    <p><b>Opportunity Type</b>: Remote/Virtual</p>
                    ...
                    <ol>
                        <li>Enthusiasm and interest in working with young adults.</li>
                        <li>Tutors with skills in STEM subjects are encouraged to apply.</li>
                    </ol>
            ...
            <x-kernl-accordion.item title="Community Servings">
                <div class="prose max-w-3xl">
                    ...
                    <p><b>Population Served</b>: Our clients are not on site during volunteer service but we serve individuals living with chronic illness.</p>

                    <p><b>Location</b>: 179 Amory Street, Jamaica Plain, MA 02130</p>

                    <p><b>Primary Focus</b>: Food Security, Nutrition and Meal Assistance</p>

                    <p><b>Type of Placement</b>: Group Placement (up to 5 people)</p>

                    <p><b>Opportunity Type</b>: In person</p>

                    <p><b>Activities</b>:</p>
                    <ul>
                        <li>Volunteers can expect to help with tasks like peeling and chopping vegetables</li>
                        <li>Portioning and packaging food</li>
                        <li>Packing meal bags for delivery to our clients.</li>
                    </ul>
                    <p><b>Skills/Qualifications</b>:</p>
                    <ol>
                        <li>Ability to stand for the duration of the shift and lift heavy items</li>
                        <li>Flexibility and positive attitude</li>
                    </ol>
            ...
            <x-kernl-accordion.item title="Hernández After School Program">
                <div class="prose max-w-3xl">
                    ...
                    <p><b>Activities</b>:</p>
                    <ul>
                        <li>Volunteers will work with their partnered students and assist them with their current educational studies, including  guiding them through homework, additional needed review, test or quiz preparation and fun educational enrichment  activities</li>
                        <li>If time allows, conducting additional educational and interactive activities.</li>
                    </ul>
                    <p><b>Skills/Qualifications</b>:</p>
                    <ol>
            ...
            <x-kernl-accordion.item title="Hyde Square Task Force">
                <div class="prose max-w-3xl">
                    ...
                    <p><b>Skills/Qualifications</b>:</p>
                    <ol>
                        <li>Not required, but would be nice to have Spanish speakers. We welcome all!</li>
                    </ol>
                    <p><b>Requirements</b>:</p>
                    <ul>
                        <li>CORI</li>
