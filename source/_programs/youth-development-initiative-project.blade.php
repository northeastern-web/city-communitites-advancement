...
@section('content')
    ...
    <div class="prose max-w-3xl lg:prose-lg mt-12 mb-4">
        ...
        <ul>
            ...
            <li>Attend the YDIP Saturday program once a month</li>
            <li>Ask for help when needed</li>
            <li>Complete required summer reading</li>
            <li>Aspire to maintain at least at 3.0 GPA</li>
        </ul>
        <p>YDIP expects parents to:</p>
        <ul>
            <li>Attend YDIP workshops and other activities one Saturday per month. These events may include discussions of student progress, workshops on financial literacy, and guidance about effective parenting for academic success.</li>
