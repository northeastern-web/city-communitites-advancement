...
@section('content')
    <div class="prose max-w-3xl lg:prose-lg">
        ...
        <h5 class="font-bold">Youth Worker Competency Training Examples</h5>
        <ul>
        ...
        <h5 class="font-bold">Professional Development Competency Training Examples</h5>
        <ul>
        ...
        <h5 class="font-bold">Culturally Responsive Educator Training Examples</h5>
        <ul>
        ...
        <p>Alumni Mentors are matched with current Fellows to help guide them through their year of service and beyond. Contact <a href="mailto:l.currie@northeastern.edu">l.currie@northeastern.edu</a> to learn more.</p>
        <h5 class="font-bold">Be a Monthly Meeting Trainer</h5>
        <p>In this program, MPF alumni share their skills and experiences with current Fellows in workshops, trainings, and monthly meetings. Contact <a href="mailto:e.conwelll.currie@northeastern.edu">e.conwell@northeastern.edu</a> to learn more.</p>
        <h5 class="font-bold">Serve as a Community Grant Reviewer</h5>
        <p>Support MPF in selecting our host sites each year. Reviewers read a selection of proposals and come together to make final recommendations in February. Contact <a href="mailto:l.curriec.holohan@northeastern.edu">l.currie@northeastern.edu</a> to learn more.</p>
        <h3>Annual events</h3>
        ...
        <h3>Criteria to host a Fellow</h3>
        ...
        <h3>Recruit and Select a Fellow</h3>
